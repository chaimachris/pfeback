...
namespace DeliverWholesale.Migrations
{
    ...
    [Migration("20260517235909_AddPanier")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeliverWholesale.Domain.Entities.Panier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DeliverWholesale.Domain.Entities.PanierItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DeliverWholesale.Domain.Entities.Panier", b =>
                {
                    b.HasOne("DeliverWholesale.Domain.Entities.User", "User")
                        .WithOne()
                        .HasForeignKey("DeliverWholesale.Domain.Entities.Panier", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DeliverWholesale.Domain.Entities.PanierItem", b =>
                {
                    b.HasOne("DeliverWholesale.Domain.Entities.Panier", "Panier")
                        .WithMany("Items")
